...
## 产品线状态（2026-04-13）
- 🛡️ Cyber Model → ✅ 已上线 → HF Space: FFZwai/leyoai-cyber-assistant
- 🎬 Video Model → ✅ 已上线 → HF Space: FFZwai/leyoai-video-safety
- ⚙️ Flow Model → ✅ 已上线 → HF Space: FFZwai/leyoai-flow-assistant
- 📊 Analytics Model → ✅ 已上线 → HF Space: FFZwai/leyoai-analytics-assistant

## HF 资源
- LoRA 模型仓库: FFZwai/qwen2.5-1.5b-video-safety
- HF 用户: FFZwai
- Space 重命名历史: nexify-xxx → leyoai-xxx（2026-04-13，使用 move_repo API）
